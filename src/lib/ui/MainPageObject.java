...
//        By by = By.xpath(xpath);
    ...
    public void clickElementToTheRightUpperCorner(String locator, String error_message){
        WebElement element = this.waitForElementPresent(locator + "/..", error_message);//+/.. here we goes to the element higher
